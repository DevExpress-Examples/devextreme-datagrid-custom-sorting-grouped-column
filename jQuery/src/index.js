...
$(() => {
    ...
    columns: ['ID', 'CompanyName', 'City',
      {
        ...
        calculateGroupValue(rowData) {
          const isTop = rowData.State === 'California' && this.sortOrder !== 'desc';
          const isBottom = rowData.State === 'California' && this.sortOrder === 'desc';
  ...
  dataGrid = $('#gridContainer2').dxDataGrid({
    ...
    columns: ['ID', 'CompanyName', 'City',
      ...
      },
      {
        ...
        calculateCellValue(rowData) {
          const sortOrder = dataGrid ? dataGrid.columnOption('State', 'sortOrder') : 'asc';
          const isTop = rowData.State === 'California' && sortOrder !== 'desc';
          const isBottom = rowData.State === 'California' && sortOrder === 'desc';
          let sortValue = rowData.State;
          if (isTop) {
            sortValue = 'aaa';
          }
